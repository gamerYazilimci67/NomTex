...
namespace NomTex
{
    public partial class Form1 : Form
    {
        ...
        private void açToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog.Title = "NomTex | Open Files";
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {   if (richTextBox1.Text == "")
                ...
                {DialogResult result = MessageBox.Show("You didn't save file! Are you sure you won't save it?","Warning!", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
        ...
        private void textBox1_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (index != -1)
                {
                    MessageBox.Show("Value is found!", "NomTex", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    MessageBox.Show("Value is not found!", "NomTex", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
        }
