    ...
    public partial class Form1 : Form
    {
        ...
        public void ara(string aranacakMetin)
        {
            ...
            if (index != -1)
            {
                ...
                MessageBox.Show("Text Found", "NomTex", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Text Not Found", "NomTex", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        private void açToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenFileDialog openFileDialog = new OpenFileDialog();
            openFileDialog.Title = "NomTex | Open File";
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (kaydedildimi == false)
            {
                ...
                {
                    DialogResult result = MessageBox.Show("You didn't save your file! Would you like save the file?", "Warning!", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
